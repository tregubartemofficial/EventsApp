  ...
  useEffect(() => {
    if (open) {
      const initializeMap = () => {
        ...
        initializedMap.addControl(new tt.FullscreenControl());
        initializedMap.addControl(new tt.NavigationControl());
        initializedMap.on("load", function () {
          initializedMap.setPaintProperty("POI", "text-halo-color", "#000000");
